    ...
    <nav className="flex py-4 items-center gap-8 justify-between">
      <div className="flex items-center gap-8">
        <Link href="/" className="max-w-sm">
          <Image src={resolvedTheme === "dark" ? LogoDark : LogoLight} alt="JuniorDevResources Logo" />
        </Link>
        <Link href="project-generator" className={buttonVariants({ variant: "ghost" }) + " hidden sm:inline-flex"}>Project Generator</Link>
      </div>
